    ...
    return (
        < section className="login-section">
            ...
            {errorMessage ? Array.isArray(errorMessage) ?
                <Alert onClose={closeAlert} sx={{ position: 'fixed', width: '100%', top: '4.2%' }} variant="filled" severity="error">
                    {
                ...
                : <Alert onClose={closeAlert} sx={{ position: 'fixed', width: '100%', top: '4.2%' }} variant="filled" severity="error">{errorMessage.message}</Alert> : null
            }
        </section >
    );
}
